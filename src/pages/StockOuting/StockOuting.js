// src/pages/StockOuting/StockOuting.js
...
import { getStockOutingSearch } from '../../services/stockOutingService';
...
class StockOuting extends Component {
  constructor(props) {
    super(props);
    this.onLoad = false;
    this.state = {
  ...
  async getStockSearch() {
    ...
    const results = await getStockOutingSearch(client, { branchs_id, stock_date });
...
export default withApollo(withUser(withDialog(withTranslation()(StockOuting))));
